...
var appendLinkFunctions = function appendLinkFunctions(resultObject, links) {
...
var buildResultObject = function buildResultObject(response) {
  var result = {
    entries: []
  };
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 8:
                ...
                return _context.abrupt("return", buildResultObject(response.data));
