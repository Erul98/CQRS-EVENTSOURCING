...
var buildCreateOptions = function buildCreateOptions(config, name, projectionContent, mode, enabled, emitEnabled, checkpointsEnabled) {
  var options = {
...
var _default = function _default(config, getAllProjectionsInfo) {
  return (/*#__PURE__*/function () {
      var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(name, projectionContent, mode, enabled, checkpointsEnabled, emitEnabled) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 11:
                ...
                options = {};
                if (!projectionExists) options = buildCreateOptions(config, name, projectionContent, mode, enabled, emitEnabled, checkpointsEnabled);else options = buildUpdateOptions(config, name, projectionContent, emitEnabled);
